...
export default function AboutUs() {
  return (
    <section id="about" className="bg-[#111111] text-white py-32 px-4 md:px-8">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16">
        <div>
          <span className="text-blue-500 font-bold tracking-widest uppercase text-sm mb-4 block">About Us</span>
          ...
          <p className="text-xl text-zinc-400 font-medium leading-relaxed border-l-2 border-blue-500 pl-6">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2rem] p-10">
          <h3 className="text-3xl font-bold mb-6">Your Single Point of Contact for CAD Software</h3>
